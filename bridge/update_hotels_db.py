...
from hotels.models import Hotel, Photo
import json

f = open("/Users/aditdhawan/Documents/projects/scrapeBooking/hotels.json")
data = json.load(f)
...
for name in data.keys():
    ...
    h = Hotel(name=name, address=hotel_row[0],longitude=longitude, 
